...
--
-- Host: localhost:3306
-- Generation Time: Mar 15, 2026 at 11:13 AM
...
INSERT INTO `banners` (`banner_id`, `title`, `description`, `image_url`, `mobile_image_url`, `link_url`, `is_active`, `created_at`) VALUES
(1, 'ghfgoe', 'uryiuytikut', 'storage/banners/1773317912_screenshot-2026-03-10-033409.webp', 'storage/banners/1773317912_mobile_screenshot-2026-03-10-162231.webp', NULL, 1, '2026-03-12 12:18:32');
...
CREATE TABLE `products` (
  ...
  `avg_review_rating` float DEFAULT 0,
  `is_active` tinyint(1) DEFAULT 1,
  `created_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
